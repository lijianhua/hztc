<div class="carousel slide" data-ride="carousel" id="ad-carousel-{{ $ad->id }}">
  ...
  <!-- Controls -->
    <a class="left carousel-control" href="#ad-carousel-{{ $ad->id }}" role="button" data-slide="prev">
      <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
      <span class="sr-only">Previous</span>
    </a>
    <a class="right carousel-control" href="#ad-carousel-{{ $ad->id }}" role="button" data-slide="next">
