...
$(document).ready(function(){
	$(".filter-mark-change #s_province").change(function(){
		var id_index = document.getElementById('s_province').selectedIndex;
		...
		if(this_val != ""){
			...
			if(add_text){
				$(".filter-selected dl").append("<dd data-value="+$(this).val()+" data-index="+id_index+" class='filter-selected-item selected_"+id_index+"'><i>"+$(this).val()+"</i><span class='filter-delete'></span></dd>");
			}
		}

	});
	$(".filter-mark-change #s_city").change(function(){
		var this_val = $(this).val();
		if(this_val != ""){
			var id_index = document.getElementById('s_province').selectedIndex;
			var id_index_city = document.getElementById('s_city').selectedIndex;
			$(".selected_"+id_index+" i").text($(this).val())
			$(".selected_"+id_index+"").attr('data-index',id_index.toString()+id_index_city.toString())
		}

	});
	$(".filter-mark-change #s_county").change(function(){
		var this_val = $(this).val();
		if(this_val != ""){
			var id_index = document.getElementById('s_province').selectedIndex;
			var id_index_city = document.getElementById('s_city').selectedIndex;
			var id_index_county = document.getElementById('s_county').selectedIndex;
			$(".selected_"+id_index+" i").text($(this).val());
			$(".selected_"+id_index+"").attr('data-index',id_index.toString()+id_index_city.toString()+id_index_county.toString())
		}
